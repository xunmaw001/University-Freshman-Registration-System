<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="班级编号" prop="banjibianhao">
					<el-input v-model="ruleForm.banjibianhao" placeholder="班级编号" clearable  :readonly="ro.banjibianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="班级编号" prop="banjibianhao">
					<el-input v-model="ruleForm.banjibianhao" placeholder="班级编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="班级人数" prop="banjirenshu">
					<el-input v-model="ruleForm.banjirenshu" placeholder="班级人数" clearable  :readonly="ro.banjirenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="班级人数" prop="banjirenshu">
