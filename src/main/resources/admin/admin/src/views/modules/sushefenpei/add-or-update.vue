<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="宿舍名称" prop="sushemingcheng">
					<el-select :disabled="ro.sushemingcheng" @change="sushemingchengChange" v-model="ruleForm.sushemingcheng" placeholder="请选择宿舍名称">
						<el-option
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.sushemingcheng" label="宿舍名称" prop="sushemingcheng">
					<el-input v-model="ruleForm.sushemingcheng" placeholder="宿舍名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="宿舍类型" prop="susheleixing">
					<el-input v-model="ruleForm.susheleixing" placeholder="宿舍类型" clearable  :readonly="ro.susheleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="宿舍类型" prop="susheleixing">
					<el-input v-model="ruleForm.susheleixing" placeholder="宿舍类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="系别" prop="xibie">
					<el-input v-model="ruleForm.xibie" placeholder="系别" clearable  :readonly="ro.xibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="系别" prop="xibie">
					<el-input v-model="ruleForm.xibie" placeholder="系别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="分配时间" prop="fenpeishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.fenpeishijian" label="分配时间" prop="fenpeishijian">
	...
	methods: {
		...
		init(id,type) {
			...
			sushemingchengChange () {
				this.$http({
					url: `follow/sushexinxi/sushemingcheng?columnValue=`+ this.ruleForm.sushemingcheng,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						...
						if(data.data.xibie){
							this.ruleForm.xibie = data.data.xibie
						}
